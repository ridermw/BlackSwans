...
### Main Result (200-day MA, 1928-2026)

| Metric | Buy-and-Hold | Trend-Following | Improvement |
|--------|-------------|-----------------|-------------|
| CAGR | 6.01% | 16.63% | +10.62pp |
...
Trend-following reduces maximum drawdown from -86% to -26% and volatility from 19% to 12%. The CAGR improvement is substantial (+10.6pp) and the Sharpe ratio more than triples (0.40 → 1.32). The drawdown reduction is the key finding consistent with Faber's claim: trend-following **avoids worst-case volatility**.
...
### Data
- S&P 500 price data from Yahoo Finance, 1928-09-04 to 2026-05-22
- Daily percentage returns computed via `pct_change(fill_method=None)`
- 24,544 trading days (original validation used 20,673 days through 2010-12-31)
...
## Extended Validation: 1928-2026

The original validation used data through December 2010 (matching Faber's paper). We re-validated all four claims using an extended dataset through May 2026, adding more than 15 years of market events including the COVID-2020 crash, 2022 downturn, 2023-2024 rally, and subsequent 2025-2026 data.

### Comparison: 1928-2010 vs 1928-2026

| Metric | 1928-2010 (20,674 days) | 1928-2026 (24,544 days) | Change |
|--------|------------------------|------------------------|--------|
| **Claim 1: Fat tails** | | | |
| Excess kurtosis | 17.60 | 17.29 | Slightly lower (COVID added extreme days but also more normal days) |
| Jarque-Bera p-value | ≈ 0 | ≈ 0 | Unchanged |
| **Claim 2: Outsized influence** | | | |
| CAGR impact (miss 10 best) | 1.41pp (CI: [1.19%, 1.63%]) | 1.20pp (CI: [1.02%, 1.37%]) | Diluted slightly by more data, still highly significant |
| **Claim 3: Clustering** | | | |
| % outliers in downtrends | 70.7% | 72.3% | *Strengthened* |
| Chi-squared p-value | 4.7 × 10⁻⁵² | 6.2 × 10⁻⁸¹ | *Strengthened* |
| **Claim 4: Trend-following** | | | |
| Strategy CAGR | 16.1% | 16.6% | Stable |
| Buy-hold CAGR | 4.9% | 6.0% | Higher (post-2010 period included strong bull markets) |
...
### Cross-Index Validation (2026 Data)
...
|-------|------|-----------|----------|-------------------|-------------|----------------|
| S&P 500 | 24,544 | CONFIRMED | CONFIRMED | 6.2 × 10⁻⁸¹ | 72.3% | CONFIRMED |
| Nikkei 225 | 13,862 | CONFIRMED | CONFIRMED | 2.8 × 10⁻⁴⁸ | 78.7% | CONFIRMED |
| FTSE 100 | 10,706 | CONFIRMED | CONFIRMED | 3.0 × 10⁻⁷⁴ | 88.8% | CONFIRMED |
| DAX | 9,706 | CONFIRMED | CONFIRMED | 9.9 × 10⁻⁶⁹ | 87.0% | CONFIRMED |
| Hang Seng | 9,719 | CONFIRMED | CONFIRMED | 3.8 × 10⁻²⁶ | 74.7% | CONFIRMED |

### Key Finding

All four claims are **robustly confirmed** with the extended data across all markets tested. The clustering result (Claim 3) remains extremely significant — the COVID-2020 crash and later market data produced extreme outlier days that clustered heavily during bear market phases, adding further evidence for Faber's thesis. The S&P 500 p-value dropped from 10⁻⁵² to 10⁻⁸¹. REITs, EAFE, FTSE, and DAX show the strongest clustering among the refreshed datasets.
