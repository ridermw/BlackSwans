...
The `data/` directory contains 12 cached CSV files from Yahoo Finance, each representing a market index or asset class analyzed using historical data through May 22, 2026.

### Equity Indices

#### 1. S&P 500 (`_GSPC_1928-09-04_to_2026-05-22.csv`)
- **Ticker:** ^GSPC
- **Asset Class:** Large-cap U.S. equities
- **Date Range:** Sept 4, 1928 – May 22, 2026
- **Rows:** 24,545
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
- **Notes:** Longest historical record; primary analysis index for original Faber paper

#### 2. MSCI EAFE (`EFA_2001-08-27_to_2026-05-22.csv`)
- **Ticker:** EFA
- **Asset Class:** Developed markets (Europe, Australasia, Far East)
- **Date Range:** Aug 27, 2001 – May 22, 2026
- **Rows:** 6,221
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
- **Notes:** Emerging vs. developed market comparison

#### 3. MSCI Emerging Markets (`EEM_2003-04-14_to_2026-05-22.csv`)
- **Ticker:** EEM
- **Asset Class:** Emerging market equities
- **Date Range:** Apr 14, 2003 – May 22, 2026
- **Rows:** 5,815
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
- **Notes:** Higher volatility profile; captures extreme outlier events

#### 4. REITs (`VNQ_2004-09-29_to_2026-05-22.csv`)
- **Ticker:** VNQ
- **Asset Class:** Real estate investment trusts (U.S. residential & commercial)
- **Date Range:** Sept 29, 2004 – May 22, 2026
- **Rows:** 5,447
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
- **Notes:** Alternative asset class for comparison

#### 5. Aggregate Bonds (`AGG_2003-09-29_to_2026-05-22.csv`)
- **Ticker:** AGG
- **Asset Class:** U.S. bonds (investment grade)
- **Date Range:** Sept 29, 2003 – May 22, 2026
- **Rows:** 5,699
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
...
#### 6. ASX 200 (Australia) (`_AXJO_1992-11-23_to_2026-05-22.csv`)
- **Ticker:** ^AXJO
- **Asset Class:** Australian equities
- **Date Range:** Nov 23, 1992 – May 22, 2026
- **Rows:** 8,467
- **Source:** Yahoo Finance

#### 7. CAC 40 (France) (`_FCHI_1990-03-01_to_2026-05-22.csv`)
- **Ticker:** ^FCHI
- **Asset Class:** French equities
- **Date Range:** Mar 1, 1990 – May 22, 2026
- **Rows:** 9,199
- **Source:** Yahoo Finance

#### 8. FTSE 100 (UK) (`_FTSE_1984-01-03_to_2026-05-22.csv`)
- **Ticker:** ^FTSE
- **Asset Class:** British equities
- **Date Range:** Jan 3, 1984 – May 22, 2026
- **Rows:** 10,707
- **Source:** Yahoo Finance

#### 9. DAX (Germany) (`_GDAXI_1987-12-30_to_2026-05-22.csv`)
- **Ticker:** ^GDAXI
- **Asset Class:** German equities
- **Date Range:** Dec 30, 1987 – May 22, 2026
- **Rows:** 9,707
- **Source:** Yahoo Finance

#### 10. Nikkei 225 (Japan) (`_N225_1970-01-05_to_2026-05-22.csv`)
- **Ticker:** ^N225
- **Asset Class:** Japanese equities
- **Date Range:** Jan 5, 1970 – May 22, 2026
- **Rows:** 13,863
- **Source:** Yahoo Finance

#### 11. Hang Seng (Hong Kong) (`_HSI_1986-12-31_to_2026-05-22.csv`)
- **Ticker:** ^HSI
- **Asset Class:** Hong Kong equities
- **Date Range:** Dec 31, 1986 – May 22, 2026
- **Rows:** 9,720
- **Source:** Yahoo Finance

#### 12. TSX (Canada) (`_GSPTSE_1979-06-29_to_2026-05-22.csv`)
- **Ticker:** ^GSPTSE
- **Asset Class:** Canadian equities
- **Date Range:** Jun 29, 1979 – May 22, 2026
- **Rows:** 11,775
- **Source:** Yahoo Finance
...
- **Example:** `_GSPC_1928-09-04_to_2026-05-22.csv`
