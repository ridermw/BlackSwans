...
The `data/` directory contains 12 cached CSV files from Yahoo Finance, each representing a market index or asset class analyzed using historical data through December 31, 2010.

### Equity Indices

#### 1. S&P 500 (`_GSPC_1928-09-01_to_2010-12-31.csv`)
- **Ticker:** ^GSPC
- **Asset Class:** Large-cap U.S. equities
- **Date Range:** Sept 1, 1928 – Dec 31, 2010
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
- **Notes:** Longest historical record; primary analysis index for original Faber paper

#### 2. MSCI EAFE (`EFA_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** EFA
- **Asset Class:** Developed markets (Europe, Australasia, Far East)
- **Date Range:** Jan 1, 1970 – Dec 31, 2010
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
- **Notes:** Emerging vs. developed market comparison

#### 3. MSCI Emerging Markets (`EEM_1988-01-01_to_2010-12-31.csv`)
- **Ticker:** EEM
- **Asset Class:** Emerging market equities
- **Date Range:** Jan 1, 1988 – Dec 31, 2010
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
- **Notes:** Higher volatility profile; captures extreme outlier events

#### 4. REITs (`VNQ_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** VNQ
...
#### 5. Aggregate Bonds (`AGG_1976-01-01_to_2010-12-31.csv`)
- **Ticker:** AGG
- **Asset Class:** U.S. bonds (investment grade)
- **Date Range:** Jan 1, 1976 – Dec 31, 2010
- **Source:** Yahoo Finance
- **Columns:** Date (index), Close (float)
...
#### 6. ASX 200 (Australia) (`_AXJO_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** ^AXJO
- **Asset Class:** Australian equities
- **Date Range:** Jan 1, 1970 – Dec 31, 2010
- **Source:** Yahoo Finance

#### 7. CAC 40 (France) (`_FCHI_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** ^FCHI
- **Asset Class:** French equities
- **Date Range:** Jan 1, 1970 – Dec 31, 2010
- **Source:** Yahoo Finance

#### 8. FTSE 100 (UK) (`_FTSE_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** ^FTSE
- **Asset Class:** British equities
- **Date Range:** Jan 1, 1970 – Dec 31, 2010
- **Source:** Yahoo Finance

#### 9. DAX (Germany) (`_GDAXI_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** ^GDAXI
- **Asset Class:** German equities
- **Date Range:** Jan 1, 1970 – Dec 31, 2010
- **Source:** Yahoo Finance

#### 10. Nikkei 225 (Japan) (`_N225_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** ^N225
- **Asset Class:** Japanese equities
- **Date Range:** Jan 1, 1970 – Dec 31, 2010
- **Source:** Yahoo Finance

#### 11. Hang Seng (Hong Kong) (`_HSI_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** ^HSI
- **Asset Class:** Hong Kong equities
- **Date Range:** Jan 1, 1970 – Dec 31, 2010
- **Source:** Yahoo Finance

#### 12. TSX (Canada) (`_GSPTSE_1970-01-01_to_2010-12-31.csv`)
- **Ticker:** ^GSPTSE
...
- **Example:** `_GSPC_1928-09-01_to_2010-12-31.csv`
